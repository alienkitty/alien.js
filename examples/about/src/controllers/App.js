import { Stage, UI, WebAudio, clearTween, delayedCall, ticker, wait } from '@alienkitty/space.js/three';
...
AudioMicro
        ...
        this.ui.detailsUsers = this.ui.details.content[this.ui.details.content.length - 1].children[1];
