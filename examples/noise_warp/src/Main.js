...
import { Events, Stage, Interface, Component, Canvas, CanvasFont, Device, Mouse, Assets, AssetLoader, FontLoader, TweenManager, Shader } from '../alien.js/src/Alien';

import vertBasicShader from './shaders/basic_shader.vert';
import fragBasicShader from './shaders/basic_shader.frag';
import vertNoiseWarp from './shaders/noise_warp.vert';
import fragNoiseWarp from './shaders/noise_warp.frag';
...
class TitleTexture extends Component {
    ...
    constructor() {
        ...
        this.update = () => {
            ...
            text = CanvasFont.createText(canvas, Stage.width, Stage.height, 'Noise Warp'.toUpperCase(), '200 66px Oswald', Config.UI_COLOR, {
                lineHeight: 80,
                letterSpacing: 0,
                textAlign: 'center'
            });
...
class Space extends Component {
    ...
    constructor() {
        ...
        function initMesh() {
            ...
            shader = self.initClass(Shader, vertNoiseWarp, fragNoiseWarp, {
                time: World.time,
                resolution: World.resolution,
