...
class AlienKittyTexture extends Component {
    ...
    constructor() {
        ...
        function initCanvas() {
            canvas = self.initClass(Canvas, 960, 540, true);
            self.canvas = canvas;
        ...
        function finishSetup() {
            ...
            alienkitty.transform({ x: (960 - 90) / 2, y: (540 - 86) / 2 });
            ...
            eyelid2.transform({ x: 53, y: 26, scaleX: 1, scaleY: 0.01 });
