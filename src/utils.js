...
const singletons = (values = []) => bundleutils.singletons(['Stage', 'CanvasFont', 'Render', 'Device', 'Mouse', 'Accelerometer', 'Utils', 'TweenManager', 'Interpolation', 'Images', 'SVGSymbol', 'Storage', 'WebAudio', 'Utils3D'].concat(values));
